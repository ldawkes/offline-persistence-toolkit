...
define(["./keyValuePersistenceStore", "../persistenceStoreManager", "./logger"], function (
	keyValuePersistenceStore,
	...
	FileSystemPersistenceStore.prototype.updateKey = function (currentKey, newKey) {
		logger.log(
			"Offline Persistence Toolkit FileSystemPersistenceStore: updateKey() with currentKey: " +
				currentKey +
				" and new key: " +
				newKey
		);
		var self = this;
		return _findByKeyFileIndex(currentKey)
